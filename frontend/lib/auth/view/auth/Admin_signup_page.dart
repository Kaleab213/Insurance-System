    ...
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is AuthDataLoadingError ||
            state is AuthDataLoaded && state.userRole == "CUSTOMER") {
          Navigator.push(
            context,
            MaterialPageRoute(
      ...
      child: BlocBuilder<AuthBloc, AuthState>(
        builder: (context, state) {
          if (state is AuthDataLoaded && state.userRole == "ADMIN") {
            return Scaffold(
              appBar: AppBar(
                title: const Text(
                  "Sign Up",
            ...
            throw Exception("unathorized user to access the page");
          }
        },
      ),
    );
