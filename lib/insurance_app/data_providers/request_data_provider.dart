...
class RequestDataProvider {
  ...
  Future<Request> create(Request request) async {
    final http.Response response = await http.post(Uri.parse(_baseUrl),
        ...
        body: jsonEncode({
          ...
          "witness1Number": request.witness1Number,
          "witness2Number": request.witness2Number,
          "witness3Number": request.witness3Number,
  ...
  Future<Request> fetchByCode(String coverage_id) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception("Fetching Request by ID failed");
    }
  }
